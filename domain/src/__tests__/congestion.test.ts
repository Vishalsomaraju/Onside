...
describe('Congestion Simulator', () => {
  ...
  it('should return low congestion for gates during in-progress', () => {
    expect(getCongestion('in-progress', 'gate-north')).toBe('low');
  });

  it('should return high congestion for seating blocks during in-progress', () => {
